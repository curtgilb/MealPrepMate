...
> & {
  ingredientsByUnitType: Map<
    UnitType | "NONE",
    Map<string, ScaledRecipeIngredient[]>
  >;
};
...
function condenseUnits(
  ...
  unitMap: Map<string, MeasurementUnit>
...
function identifyTargetUnit(
  unitsByType: Map<string, ScaledRecipeIngredient[]>
) {
