...
export type MealPlanServingsFieldFragment = { __typename?: 'MealPlanServing', id: string, day: number, meal: Meal, numberOfServings: number, mealPlanRecipeId: string } & { ' $fragmentName'?: 'MealPlanServingsFieldFragment' };
...
export type AddServingToPlanMutation = { __typename?: 'Mutation', addRecipeServing: { __typename?: 'MealPlanServing', day: number, id: string, meal: Meal, mealPlanRecipeId: string, numberOfServings: number, mealRecipe: { __typename?: 'MealPlanRecipe', id: string, servingsOnPlan: number } } };
